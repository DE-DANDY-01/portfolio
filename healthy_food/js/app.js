(() => {
    ...
    (() => {
        ...
        let fullScreenMain = document.querySelector(".full-screen-main");
        if (fullScreenMain) {
            const trueHeightWithPx = getComputedStyle(fullScreenMain).height;
            const trueHeight = trueHeightWithPx.slice(0, trueHeightWithPx.length - 2);
